...
//setters
void set_senia(string URL, unsigned int ancho, unsigned int alto, bool a_color, float senia);
...
float get_senia(unsigned int ancho, unsigned int alto, float senia, bool a_color);
